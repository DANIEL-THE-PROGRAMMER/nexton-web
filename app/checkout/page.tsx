...
export default function Checkout() {
  return (
    <>
      <div className="">
        <div className="container mx-auto pt-[40px] font-poppins">
          ...
          <div className="mt-[52px] flex gap-[40px]">
            <div className="w-[50%] shrink-[1] flex flex-col gap-[40px]">
              <div className="border-[#E5E7EB] border-[1px] rounded-[16px]">
                ...
                <div className="flex px-[24px] pt-[24px] pb-[32px] gap-[24px]">
            ...
            <div className="w-[50%] shrink-[1] font-poppins">
              <h5 className="text-[#111827] text-[24px] font-semibold leading-[32px] mb-[24px]">
                Order summary
              </h5>
